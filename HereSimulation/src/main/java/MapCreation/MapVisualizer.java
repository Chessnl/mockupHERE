...
public class MapVisualizer extends JFrame  {
    ...
    private int lengthArrow = 5; // the length of legs of the arrows
    ...
    // There is a bug in the showing of arrows and is therefore disabled
     ...
     */
    public MapVisualizer(CityMap cityMap, boolean showGrid) {
    ...
    public void drawRoad (Graphics g, Road road) {
        ...
        // There's a big in this part and is therefore disabled
        if (showArrows) {
            //draw arrow
            ...
            double point2X = baseX - temp1Y;
            double point2Y = baseY + temp1X;
            double point3X = baseX + temp1Y;
            double point3Y = baseY - temp1X;
