...
public class Intersection implements Serializable {
	...
	// returns whether COMSETsystem.Intersection i is adjacent to this
	...
	// returns the road from this to COMSETsystem.Intersection i, null if i is not adjacent to this
